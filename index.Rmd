...
```{r}
plot_model(m.lm, type = "pred", title = c("Predicted Values of Domestic Grossing in Millions Based on Budget"))$budget_millions
plot_model(m.lm, type = "pred", title = c("Predicted Values of Domestic Grossing in Millions Based on Year"))$year
